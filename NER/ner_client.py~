...
if __name__ == "__main__":
    ...
    print ner.upload("memm.py") # web service for upload
    print ner.upload("feature_functions.py") # web service for upload
    print ner.upload("MyMaxEnt.py") # web service for upload
    print ner.upload("all_data.p") # web service for upload
